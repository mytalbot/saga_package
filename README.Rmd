...
In case the installation of SAGA is not possible or desired, you can also use an amazon machine image (us-east-1: ami-0787228c3430c9994). This requires an AWS account.

[AMI Link](https://console.aws.amazon.com/ec2/v2/home?region=us-east-1#LaunchInstanceWizard:ami=ami-0787228c3430c9994)
