...
### Important Note
**The SAGA package requires R >=3.6 (R!=4.0)**.
...
**However, some of the dependecies of the package have not yet been updated to R4.0. Currently, the saga package does not work with R4.0.**
